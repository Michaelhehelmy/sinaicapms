...
beforeEach(() => {
  ...
  mockOverviewResolve = { totalPredictions: 5, totalAutomationRules: 3, totalLogs: 10, totalPriceRules: 2, tenantBreakdown: [{ tenant_id: 't1', tenant_name: 'Camp', prediction_count: 5, automation_count: 3 }] };
  mockPredictionsResolve = { data: [{ id: 'p1', type: 'demand', confidence: 0.85, tenant_name: 'Camp', created_at: '2025-01-01' }], total: 1 };
