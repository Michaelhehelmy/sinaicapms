...
/**
 * Command Center inline SVG icon set.
 *
 * Small, dependency-free stroke icons (heroicons-style 24px grid) used by the
 * Admin shell sidebar, mobile bottom nav, and panel headers. Every icon:
