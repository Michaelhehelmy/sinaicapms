        ...
        <>
          ...
          <div className="flex flex-wrap items-center gap-3 mb-4 p-3 bg-gray-50 rounded-xl border border-gray-100">
            <div className="relative flex-1 min-w-[200px]">
              <svg className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
              <input
                type="text"
                value={searchTerm}
                ...
                className="w-full pl-9 pr-3 py-2 rounded-lg border border-gray-200 text-sm focus:outline-none focus:border-green-500 bg-white placeholder:text-gray-500"
              />
            </div>
            <select
              value={roleFilter}
          ...
          {editingUser && (
            ...
            >
              <div className="bg-white rounded-xl p-6 w-full max-w-sm shadow-lg">
                <h3 id="edit-role-title" className="text-sm font-bold text-gray-800 mb-4">Edit Role</h3>
                <p className="text-xs text-gray-500 mb-3">
                  Change role for <strong>{editingUser.displayName || editingUser.email}</strong>
                </p>
                <label htmlFor="edit-role-select" className="sr-only">
                  Role
                </label>
                <select
                  id="edit-role-select"
