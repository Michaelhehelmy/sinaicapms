-- Baseline 0007_hr.sql: HR + payroll + recruiting.
--
...
-- Tables: employees, leave_balances, leave_requests, leave_types, payroll_lines, payroll_runs, job_posts, applicants
...
-- Indexes
CREATE INDEX idx_applicants_job ON applicants(job_post_id);
...
CREATE INDEX idx_leave_balances_tenant_year
