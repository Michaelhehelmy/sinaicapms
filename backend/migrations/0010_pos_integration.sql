...
CREATE TABLE pos_user_sessions (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE pos_stock_adjustments (
    ...
    FOREIGN KEY (store_id) REFERENCES pos_stores(id),
    FOREIGN KEY (created_by) REFERENCES pos_users(id),
    FOREIGN KEY (approved_by) REFERENCES pos_users(id)
);
...
CREATE TABLE pos_transactions (
    ...
    FOREIGN KEY (voided_by) REFERENCES pos_users(id),
    FOREIGN KEY (refunded_by) REFERENCES pos_users(id)
);
...
CREATE TABLE pos_user_achievements (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    user_id INTEGER NOT NULL,
    ...
    FOREIGN KEY (user_id) REFERENCES pos_users(id),
    FOREIGN KEY (achievement_id) REFERENCES pos_achievements(id),
    UNIQUE(user_id, achievement_id)
);

CREATE TABLE pos_gamification_stats (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    user_id INTEGER NOT NULL,
...
CREATE TABLE pos_analytics_daily (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    organization_id INTEGER NOT NULL,
    store_id INTEGER,
    date DATE NOT NULL,
...
-- Analytics indexes
CREATE INDEX idx_analytics_daily_org_store_date ON pos_analytics_daily(organization_id, store_id, date);
CREATE INDEX idx_analytics_daily_date ON pos_analytics_daily(date);

-- Gamification indexes
CREATE INDEX idx_user_achievements_user ON pos_user_achievements(user_id);
CREATE INDEX idx_gamification_stats_user_period ON pos_gamification_stats(user_id, period_type, period_date);

-- Audit logs indexes
CREATE INDEX idx_audit_logs_user ON pos_audit_logs(user_id);
CREATE INDEX idx_audit_logs_organization ON pos_audit_logs(organization_id);
CREATE INDEX idx_audit_logs_date ON pos_audit_logs(created_at);
CREATE INDEX idx_audit_logs_action ON pos_audit_logs(action);
...
-- Auto-update pos_inventory after stock movement
