-- Baseline 0012_ai.sql: AI predictions + pricing + automation.
--
...
-- Tables: predictions, price_rules, automation_rules, automation_logs
...
CREATE INDEX idx_predictions_type ON predictions(model_type);
